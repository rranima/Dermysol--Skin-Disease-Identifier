...
This project is developed with Django Web Framework that serves trained CNN architecture using transfer learning to classify the input image 
into one of the different classes of skin disease.
